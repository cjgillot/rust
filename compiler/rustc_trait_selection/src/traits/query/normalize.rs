                ...
                match self.param_env.reveal() {
                    ...
                    Reveal::All => {
                        ...
                        if !recursion_limit.value_within_limit(self.anon_depth) {
                            // We have been recursive without limits.  Since we want to make
                            // progress without halting compilation, fall back to the worse path of
                            // not revealing the opaques.
